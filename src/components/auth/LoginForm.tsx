...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-white to-purple-200 px-4 py-6">
      ...
      {/* CARD */}
      <div className="w-full max-w-sm sm:max-w-md bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-6">

        {/* Logo */}
        <div className="flex justify-center mb-3">
          <div className="bg-purple-100 p-3 rounded-2xl">
            <Clapperboard size={36} className="text-purple-600" />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-purple-600 text-white font-medium hover:bg-purple-700 active:scale-[0.98] transition mt-1"
          >
            Login
          </button>
          ...
          <button
            type="button"
            onClick={() => navigate("/")}
            className="w-full flex items-center justify-center gap-1 text-purple-600 hover:text-purple-700 text-sm transition"
          >
            <ArrowLeft size={15} />
            Back to Home
          </button>
